            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <a class="add_to_cart_button" data-quality="1" data_product_id="70" rel="nofollow" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add">Comprar</a>
                    </div>
                    </div>
                    </div> 
                   <?php } ?> 
